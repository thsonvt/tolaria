...
import { restoreHighlightsInBlocks, type EditorBlock as HighlightEditorBlock } from '../utils/highlightMarkdown'
...
function serializeEditorBody(editor: ReturnType<typeof useCreateBlockNote>): string {
  const restored = restoreHighlightsInBlocks(
    restoreWikilinksInBlocks(editor.document) as HighlightEditorBlock[],
  )
